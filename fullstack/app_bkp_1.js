...
// suppose we have /details router under catergory and product 
// then how execute it . the first one /details router will run 
// this is bad design -- to retain modularity wew should go for express.router
